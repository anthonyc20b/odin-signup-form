...
Flexbox clicked for me on this project. I'd used it before but this was the first time I felt like I was actually controlling the layout rather than guessing until it looked right. Scaffolding out the project, how each section needed to be structured, and how I would set up each container for efficient styling. 
